...
(use-package projectile-speedbar
  :bind
  ("<f2>" . projectile-speedbar-open-current-buffer-in-tree))
...
;; Clear whitespace when saving a file
...
(custom-set-variables
 ...
 '(backup-directory-alist (quote (("." . "~/.emacs.d/backups/per-save"))))
